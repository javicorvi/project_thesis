...
for s in structures:
    ...
    file_pdb = open("../pdbs/2trx_edit.pdb")
    ...
    model_name="1"
    chain_name="A"
    contact_map=contact_map_path+"contact_map_2trx_1thx.dat"
    ...
    if(data_analisys):
        ...
        util.sincronize_contact_map("../2trx_s3_w0/contact_map/contact_map_2trx_edit.dat","../2trx_s3_w0/contact_map/contact_map_2trx_edit.datsync",0,103)
        #matriz de contacto 2trx 1thx
        #m1=util.load_contact_map("../1thx_s3_w0/contact_map/contact_map_1thx_edit.datsync")
        #m2=util.load_contact_map("../2trx_s3_w0/contact_map/contact_map_2trx_edit.datsync")
        #m3=util.add_matrix(m1, m2)
        #util.save_contact_map(m3,contact_map)
        dataanalisys.run_analisys(zmip_natural_result_file, mi_results_path, pattern,contact_map,mi_results_plot_path, window)    
